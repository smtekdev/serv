                    ...
                    <div class="col-lg-12">
                        <div class="">
                            <div class="widget-content searchable-container grid">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="productname" class="strong">Store Name</label>
                                                    <input id="productname" name="productname" type="text" class="form-control form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="manufacturername" class="">Vendor Name</label>
                                                    <input id="manufacturername" name="manufacturername" type="text" class="form-control form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="manufacturername" class="">Vendor ID</label>
                                                    <input id="manufacturername" name="manufacturername" type="text" class="form-control form-control">
                                                </div>                                                
                                                <div class="form-group">
                                                    <label for="manufacturername" class="">Business Address</label>
                                                    <input id="manufacturername" name="manufacturername" type="text" class="form-control form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="manufacturername" class="">Vendor ID</label>
                                ...
                                <div class="card-box add-product">
                                    <h6 class="mb-4">Store Profile Picture</h6>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="dropzone">
