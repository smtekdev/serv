                            ...
                            <div class="widget-content searchable-container grid">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-7 filtered-list-search align-self-center">
                                            <form class="form-inline my-2 my-lg-0">
                                                <div class="">
                                                    ...
                                                    <input type="text" id="input-search" class="form-control search-form-control  ml-lg-auto" placeholder="Search Category">
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="searchable-items grid card-box">
                                    ...
                                    <div class="items">
                                        <div class="">
                                            <div class="product-info">
                                                <img src="admindb/assets/img/product-5.jpg" alt="avatar">
                                            ...
                                            <div class="product-rating">
                                                <p class="product-rating-inner"><span>Rating: </span>
                                                    <a class="d-flex align-center">
                                                        5  <img src="admindb/assets/img/star.png" class="avatar-xxs ml-2" alt="star">
                                                    </a>
                                                </p>
                                            </div>
                                            <div class="product-stock-status">
                                    ...
                                    <div class="items">
                                        <div class="">
                                            <div class="product-info">
                                                <img src="admindb/assets/img/product-1.jpg" alt="avatar">
                                                <div class="user-meta-info">
                                                    <p class="product-name">Headphone</p>
                                            ...
                                            <div class="product-rating">
                                                <p class="product-rating-inner"><span>Rating: </span>
                                                    <a class="d-flex align-center">
                                                        3  <img src="admindb/assets/img/star.png" class="avatar-xxs ml-2" alt="star">
                                                    </a>
                                                </p>
                                            </div>
                                            <div class="product-stock-status">
                                    ...
                                    <div class="items">
                                        <div class="">
                                            <div class="product-info">
                                                <img src="admindb/assets/img/product-2.jpg" alt="avatar">
                                                <div class="user-meta-info">
                                            ...
                                            <div class="product-rating">
                                                <p class="product-rating-inner"><span>Rating: </span>
                                                    <a class="d-flex align-center">
                                                        4 <img src="admindb/assets/img/star.png" class="avatar-xxs ml-2" alt="star">
                                                    </a>
                                                </p>
                                            </div>
                                            <div class="product-stock-status">
